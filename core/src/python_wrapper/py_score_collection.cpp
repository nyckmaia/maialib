...
//         py::arg("includeSubFolders") = false,
//         py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());

//     cls.def(py::init<const std::string&, const std::vector<std::string>&>(), 
//         py::arg("collectionName"), 
//         py::arg("directoryPaths") = std::vector<std::string>(),
//         py::arg("includeSubFolders") = false,
//         py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());
...
//     cls.def("setDirectoryPath", &ScoreCollection::setDirectoryPath, 
//         py::arg("directoryPath"), py::arg("includeSubFolders") = false,
//         py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());
    
//     cls.def("setDirectoryPaths", &ScoreCollection::setDirectoryPaths, 
//         py::arg("directoryPaths"), py::arg("includeSubFolders") = false,
//         py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());
