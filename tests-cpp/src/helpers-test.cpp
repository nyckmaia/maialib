...
//   a
//   // calculator) Enter with a given frequency (not in the table) and
//   calculate
//   // the deviation (in CENTS) from the closest  frequency (up or down) from
//   the
//   // table. float midi_50cents_up = 1.029302; // this factor increase 50
//   cents
...
//   // EXPECT_EQ(testing::internal::GetCapturedStderr(), "[maiacore] The MIDI
//   Note
...
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '60'
//     cannot
//     // be wrote using 'b' accident type\nSource File: helper.cpp - Line
//     // 89\nFunction: static const std::string Helper::midiNote2pitch(int,
//     const
//     // std::string&)"));
//   } catch (...) {
...
//     // FAIL() << "Expected [maiacore] The MIDI Note '60' cannot be wrote
//     using
//     // 'x' accident type";
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), "...");
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '61'
//     cannot
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '62'
//     cannot
//     // be wrote using 'b' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '63'
//     cannot
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '64'
//     cannot
//     // be wrote using 'bb' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '65'
//     cannot
//     // be wrote using 'b' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '66'
//     cannot
//     // be wrote using 'bb' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '67'
//     cannot
//     // be wrote using 'b' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '68'
//     cannot
//     // be wrote using 'bb' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '69'
//     cannot
//     // be wrote using 'b' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '70'
//     cannot
//     // be wrote using 'x' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '71'
//     cannot
//     // be wrote using 'bb' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
...
//   } catch (std::runtime_error const& err) {
//     // EXPECT_EQ(err.what(), std::string("[maiacore] The MIDI Note '72'
//     cannot
//     // be wrote using 'b' accident type"));
//   } catch (...) {
//     FAIL() << "Expected std::runtime_error";
